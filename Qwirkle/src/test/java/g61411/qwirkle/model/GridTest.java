...
import static g61411.qwirkle.model.Direction.*;
import static g61411.qwirkle.model.Shape.*;
import static g61411.qwirkle.view.View.display;
import static org.junit.jupiter.api.Assertions.*;
import static g61411.qwirkle.model.QwirkleTestUtils.*;
...
public class GridTest {
    ...
    public class GridTestMethods {
        ...
        void test_selim() {
            ...
            grid.firstAdd(DOWN, line1);
            display(new GridView(grid));

            Tile[] line2 = new Tile[]{
                    new Tile(ORANGE, STAR),
                    new Tile(GREEN, STAR),
            };
            add(grid, 0, 1, RIGHT, line2);
            display(new GridView(grid));

            Tile[] line3 = new Tile[]{
                    new Tile(GREEN, DIAMOND),
                    new Tile(GREEN, SQUARE),
            };
            add(grid, 1, 2, DOWN, line3);
            display(new GridView(grid));
            ...
            add(grid, 1, 3, RIGHT, line4);
            display(new GridView(grid));

            Tile tile = new Tile(GREEN, ROUND);
            add(grid, 2, 4, tile);
            display(new GridView(grid));

            TileAtPosition tile1 = createTileAtpos(2, 1, new Tile(BLUE, SQUARE));
            TileAtPosition tile2 = createTileAtpos(2, 3, new Tile(GREEN, STAR));
            assertThrows(QwirkleException.class, () -> grid.add(tile1, tile2));
        ...
        public class GridTestJoueur {
            ...
            void rules_sonia_a() {
                ...
                int point = grid.firstAdd(UP, t1, t2, t3);
            ...
            void rules_cedric_b() {
                ...
                var t3 = new Tile(PURPLE, SQUARE);
                int point = add(grid, 1, 0, RIGHT, t1, t2, t3);
                assertEquals(point,7);
            ...
            void rules_Vincent_d() {
                ...
                int point = add(grid, -1, -1, UP, t1, t2);
                assertEquals(point,6);
            ...
            void rules_sonia_e() {
                ...
                TileAtPosition tile1 = createTileAtpos(0, -1, t1);
                TileAtPosition tile2 = createTileAtpos(-3, -1, t2);
                int point = grid.add(tile1, tile2);
                assertEquals(point,7);
                assertEquals(t1, get(grid, 0, -1));
            ...
            void rules_cedric_f() {
                ...
                var t2 = new Tile(RED, SQUARE);
                int point = add(grid, 1, 3, DOWN, t1, t2);
                assertEquals(point,6);
            ...
            void rules_Elvire_g() {
                ...
                int point = add(grid, -3, -2, LEFT, t1, t2);
                assertEquals(point, 3);
            ...
            void rules_Vincent_H() {
                ...
                int point = add(grid, -2, -3, DOWN, t1, t2);
                assertEquals(point, 3);
            ...
            void rules_sonia_i() {
                ...
                int point = add(grid, 0, -2, UP, t1, t2);
                assertEquals(point, 10);
            ...
            void rules_cedric_j() {
                ...
                int point = add(grid, -3, 0, t);
                assertEquals(point, 9);
            ...
            void rules_elvire_k() {
                ...
                Tile t2 = new Tile(RED, CROSS);
                Tile t3 = new Tile(ORANGE, CROSS);
                int point = add(grid, 2, 1, LEFT, t1, t2, t3);
            ...
            void rules_vicent_l() {
                ...
                int point = add(grid, 1, 4, DOWN, t1, t2);
                assertEquals(point, 9);
