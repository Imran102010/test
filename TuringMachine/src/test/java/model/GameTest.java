...
class GameTest {
    ...
    void testGameInitializationWithSpecificProblem() {
        ...
        assertEquals(0, game.numberOfRound());
    ...
    void testChooseCode() {
        ...
        assertTrue(code1.equals(game.getActualRound().getCodeProposal()));
    }
    ...
    void testUnChooseCode() {
        ...
        assertNull(game.getActualRound().getCodeProposal());
    }
    ...
    void testPrecedentRound() {
        ...
        assertEquals(1, game.numberOfRound());
...
/*
    ...
    void testNumberProblem() {
        ...
        assertEquals(1, game.numberProblem());
    }
}